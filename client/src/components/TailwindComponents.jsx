...
export const ProfileIcon = ({ children }) => <img class="w-6 h-6 p-1 rounded-full ring-1 ring-gray-300 dark:ring-gray-500 cursor-pointer" src="" alt="Bordered avatar">{children}</img>
...
export const HeartIcon = ({ children }) =>  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-6 h-6 cursor-pointer">
...
export const ShoppingBagIcon = () => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-6 h-6 cursor-pointer">
